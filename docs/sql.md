...
-- ============================================================================
-- 5.1 USER CARTS AND WISHLISTS
-- Persistent background sync for shopping carts and wishlists
-- ============================================================================
...
ALTER TABLE public.carts ADD COLUMN IF NOT EXISTS items JSONB NOT NULL DEFAULT '[]'::jsonb;
ALTER TABLE public.wishlists ADD COLUMN IF NOT EXISTS items JSONB NOT NULL DEFAULT '[]'::jsonb;
